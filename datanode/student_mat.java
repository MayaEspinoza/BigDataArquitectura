...
//
// Debug information:
// Generated date: Tue Sep 16 00:32:25 UTC 2025
...
public class student_mat extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.absences = JdbcWritableBridge.readInteger(1, __dbResults);
    this.activities = JdbcWritableBridge.readString(2, __dbResults);
    this.address = JdbcWritableBridge.readString(3, __dbResults);
    this.age = JdbcWritableBridge.readInteger(4, __dbResults);
    this.Dalc = JdbcWritableBridge.readInteger(5, __dbResults);
    this.failures = JdbcWritableBridge.readInteger(6, __dbResults);
    this.famrel = JdbcWritableBridge.readInteger(7, __dbResults);
    this.famsize = JdbcWritableBridge.readString(8, __dbResults);
    this.famsup = JdbcWritableBridge.readString(9, __dbResults);
    this.Fedu = JdbcWritableBridge.readInteger(10, __dbResults);
    this.Fjob = JdbcWritableBridge.readString(11, __dbResults);
    this.freetime = JdbcWritableBridge.readInteger(12, __dbResults);
    this.G1 = JdbcWritableBridge.readInteger(13, __dbResults);
    this.G2 = JdbcWritableBridge.readInteger(14, __dbResults);
    this.G3 = JdbcWritableBridge.readInteger(15, __dbResults);
    this.goout = JdbcWritableBridge.readInteger(16, __dbResults);
    this.guardian = JdbcWritableBridge.readString(17, __dbResults);
    this.health = JdbcWritableBridge.readInteger(18, __dbResults);
    this.higher = JdbcWritableBridge.readString(19, __dbResults);
    this.internet = JdbcWritableBridge.readString(20, __dbResults);
    this.Medu = JdbcWritableBridge.readInteger(21, __dbResults);
    this.Mjob = JdbcWritableBridge.readString(22, __dbResults);
    this.nursery = JdbcWritableBridge.readString(23, __dbResults);
    this.paid = JdbcWritableBridge.readString(24, __dbResults);
    this.Pstatus = JdbcWritableBridge.readString(25, __dbResults);
    this.reason = JdbcWritableBridge.readString(26, __dbResults);
    this.romantic = JdbcWritableBridge.readString(27, __dbResults);
    this.school = JdbcWritableBridge.readString(28, __dbResults);
    this.schoolsup = JdbcWritableBridge.readString(29, __dbResults);
    this.sex = JdbcWritableBridge.readString(30, __dbResults);
    this.studytime = JdbcWritableBridge.readInteger(31, __dbResults);
    this.traveltime = JdbcWritableBridge.readInteger(32, __dbResults);
    this.Walc = JdbcWritableBridge.readInteger(33, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(absences, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(activities, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(address, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(age, 4 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(Dalc, 5 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(failures, 6 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(famrel, 7 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(famsize, 8 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(famsup, 9 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(Fedu, 10 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(Fjob, 11 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(freetime, 12 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(G1, 13 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(G2, 14 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(G3, 15 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(goout, 16 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(guardian, 17 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(health, 18 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(higher, 19 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(internet, 20 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(Medu, 21 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(Mjob, 22 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(nursery, 23 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(paid, 24 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(Pstatus, 25 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(reason, 26 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(romantic, 27 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(school, 28 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(schoolsup, 29 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(sex, 30 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(studytime, 31 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(traveltime, 32 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(Walc, 33 + __off, 4, __dbStmt);
    return 33;
  }
